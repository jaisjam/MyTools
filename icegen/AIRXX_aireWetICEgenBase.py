...
class IceGen:
    ...
    def write_root_cmakelists(self, base_dir, project_name):
        ...
        with open(path, "w") as f:
            ...
            f.write("set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY ${CMAKE_BINARY_DIR})\n")
            f.write("set(CMAKE_LIBRARY_OUTPUT_DIRECTORY ${CMAKE_BINARY_DIR})\n\n")
            f.write("set_property(DIRECTORY APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS\n")
            f.write("    ${CMAKE_SOURCE_DIR}/gateware/CMakeLists.txt\n")
            f.write("    ${CMAKE_SOURCE_DIR}/gateware/*.v\n")
            f.write("    ${CMAKE_SOURCE_DIR}/gateware/*.vh\n")
            f.write("    ${CMAKE_SOURCE_DIR}/gateware/*.pcf)\n\n")
